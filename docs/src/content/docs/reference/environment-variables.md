...
| `HERMES_HOME` | Override the Hermes home used by user-scope skills and MCP config. | `~/.hermes` | Overrides deployment for the `hermes` target; directory detection still uses `.hermes/`. |
